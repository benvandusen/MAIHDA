  ...
  mutate(#Asian
    ...
    "CG Asian Black men" = Asian + Black + Asian_Black, 
         "CG Asian Black women" = Asian + Black + Asian_Black + 
          ...
          "FG Asian Black women" = Intercept +
           Black + women + women_Black +
           FG + Black_FG + women_FG + women_Black_FG,
    #Asian Hispanic
         "CG Asian Hispanic men" = Intercept +
           Hispanic,
         "CG Asian Hispanic women" = Intercept +
           Hispanic + women + women_Hispanic,
         "FG Asian Hispanic men" = Intercept +
           Hispanic +
           FG + Hispanic_FG,
         "FG Asian Hispanic women" = Intercept +
           Hispanic + women + women_Hispanic +
    ...
    "CG Asian men" = Intercept, 
         "CG Asian women" = Intercept + 
          ...
          "FG Asian women" = Intercept +
           ...
           FG + women_FG,
        #Asian White
         "CG Asian White men" = Intercept +
           White,
         "CG Asian White women" = Intercept +
           White + women + women_White,
         "FG Asian White men" = Intercept +
           White +
           FG + White_FG,
         "FG Asian White women" = Intercept +
           White + women + women_White +
    ...
    "CG Black men" = Intercept +
         ...
         "FG Black women" = Intercept +
           ...
           FG + Black_FG + women_FG + women_Black_FG,
       #Black Hispanic
    "CG Black Hispanic men" = Intercept +
           Black + Hispanic,
         "CG Black Hispanic women" = Intercept +
           Black + women + women_Black + Hispanic + women_Hispanic,
         "FG Black Hispanic men" = Intercept +
           Black + Hispanic +
           FG + Black_FG + Hispanic_FG,
         "FG Black Hispanic women" = Intercept +
           Black + Hispanic + women + women_Black + women_Hispanic +
           FG + Black_FG + Hispanic_FG + women_FG + women_Black_FG + women_Hispanic_FG,
      #Black White
        "CG Black White men" = Intercept +
           Black + White,
         "CG Black White women" = Intercept +
           Black + women + women_Black + White + women_White,
         "FG Black White men" = Intercept +
           Black + White +
           FG + Black_FG + White_FG,
         "FG Black White women" = Intercept +
           Black + White + women + women_Black + women_White +
           FG + Black_FG + White_FG + women_FG + women_Black_FG + women_White_FG,
    # #Hispanic
