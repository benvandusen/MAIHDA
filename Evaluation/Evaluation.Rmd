...
eval_df <- df %>%
  mutate(True_score = rep(Exp_val$True_score,8868),
         ...
         model = ifelse(model=="HLM_freq","Freq.",
                        ifelse(model=="HLM_bay","Bay.","MAIHDA"))) %>%
...
SD_table_wide <- SD_table_wide[,c("N_groups", "mean_Traditional_500", "mean_abs_Traditional_500",  "sd_Traditional_500", "mean_MAIHDA_500", "mean_abs_MAIHDA_500", "sd_MAIHDA_500", "mean_Traditional_1000", "mean_abs_Traditional_1000", "sd_Traditional_1000", "mean_MAIHDA_1000", "mean_abs_MAIHDA_1000", "sd_MAIHDA_1000")]
...
SD_table_wide <- test[with(test,order(N_groups)),]
SD_table_wide <- SD_table_wide[,c("N_groups", "mean_Traditional_500", "sd_Traditional_500", "mean_MAIHDA_500", "sd_MAIHDA_500","mean_Traditional_1000","sd_Traditional_1000","mean_MAIHDA_1000","sd_MAIHDA_1000")]
