...
violin_group_fun_BW <- function(Data, Group, Title, Upper, Lower){
...
```{r}
violin_group_fun(eval_df,"CG White men","CG White men",60,-60)
...
violin_group_fun_BW(eval_df,"CG White men","CG White men",60,-60)
ggsave("~/MAIHDA/Figures/Score_CGWM_BW.png", plot= last_plot(), dpi=300, width = 7.3, height = 3.25, units = "in", device = "png")

violin_group_fun_BW(eval_df,"FG Black women","FG Black women",60,-60)
ggsave("~/MAIHDA/Figures/Score_FGBW_BW.png", plot= last_plot(), dpi=300, width = 7.3, height = 3.25, units = "in", device = "png")
...
ggsave("~/MAIHDA/Figures/Score_compound_BW.png", plot= last_plot(), dpi=300, width = 11, height = 6, units = "in", device = "png")
```
